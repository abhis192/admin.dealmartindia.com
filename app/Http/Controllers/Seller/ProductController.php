...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('seller.product.create', compact('categories','brands','attributes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/seller/product')->with('success','Product created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $brands = Brand::whereStatus(1)->get(); 
        $attributes = Attribute::whereStatus(1)->get();
        return view('seller.product.edit', compact('product','categories','brands','attributes'));
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            'name' => 'required|string|min:3|max:255',
            'slug' => 'required|string|min:2|max:255|unique:products,sku,'.$id,
        ...
        $product->update($data);
        return redirect('seller/product')->with('success', 'Product has been successfully updated.');
    }
    ...
    public function featuredToggle(Request $request, $id)
    {
        ...
        return redirect('seller/product')->with('success', 'Product has been upadted successfully.');
    }
