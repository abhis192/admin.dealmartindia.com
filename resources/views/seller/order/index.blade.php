                    ...
                    <div class="card-header"> --}}
                        ...
                        {{-- <div class="filter-area">
                            <div class="row justify-content-start align-items-center">
                                <div class="col-lg-10">
                                    <form class="custom-form" method="POST" action="{{route('seller.order.filter')}}">
                                        @method('POST')
                                        @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('seller.order.detail',$order->id)}}" class="btn btn-soft-success btn-sm waves-effect waves-light" title="View Order"><i class="mdi mdi-eye font-size-16"></i></a>
                                        <a href="{{route('seller.order.invoice',$order->id)}}" class="btn btn-soft-info btn-sm waves-effect waves-light" title="Download Invoice"><i class="bx bx-download font-size-16"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
