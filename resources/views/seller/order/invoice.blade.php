                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row invoive-info">
                                                <div class="col-md-4 col-xs-4 invoice-client-info">
                                                    <h5><b>Bill to :</b></h5>
                                                    ...
                                                    <p class="m-0"><b>Address:</b>{{$order->address->address}},{{$order->address->landmark}}, {{$order->address->country}},<br/> {{$order->address->state}} {{$order->address->city}} - {{$order->address->pincode}}</p>
                                                ...
                                                <div class="col-md-6 col-xs-6 invoice-client-info">
                                                    <h5><b>Delivery Info :</b></h5>
                                                    <p class="m-0"><b>Delivery Date :</b> {{$order->delivery->delivery_date}}</p>

                                                    <p class="m-0"><b>Delivery Type :</b> {{$order->delivery->delivery_type}}</p>
                                                    <p class="m-0"><b>Delivery Time:</b> {{$order->delivery->delivery_time}}</p>
                                                        ...
                                                        <table class="table border invoice-detail-table mt-4">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if($item->product!=null)
                                                                        <p class="text-decoration-line-through m-0"><i class="fas fa-rupee-sign"></i> 150.00</p>
                                                                        <p class="m-0"><i class="fas fa-rupee-sign"></i> 100.00</p>
                                                                        @else
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <th><a href="#"></a></th>
                                                                    {{-- <th><i class="fas fa-rupee-sign"></i> 500.00</th> --}}
                                                                ...
                                                                <tr>
                                                                    <th class="text-end" colspan="2">Offer Discount :</th>
                                                                    <th></th>
                                                                    {{-- <th class="text-warning"> <i class="fas fa-rupee-sign"></i> 200.00</th> --}}
                                                                    <th class="text-warning"> - <i class="fas fa-rupee-sign"></i> {{orderItemDiscount($order->orderItems)}}</th>
                                                                </tr>
                                                                <tr>
                                                                    <th class="text-end" colspan="2">Coupon Discount :</th>
                                                                    <th>[NY2023]</th>
                                                                    {{-- <th class="text-success"> - <i class="fas fa-rupee-sign"></i> 50.00</th> --}}
                                                                    <th class="text-success"> - <i class="fas fa-rupee-sign"></i> {{orderItemCouponDiscount($order->orderItems)}}</th>
                                                                </tr>
                                                                <tr>
                                                                    <th class="text-end" colspan="2">Shipping Charges :</th>
                                                                    <th>Early Morning Delivery</th>
                                                                ...
                                                                <tr class="text-info table-light">
                                                                    <th colspan="3">
                                                                        <h5 class="text-primary m-0">Grand Total :</h5>
                                                                    </th>
                                                                    <th>
                                                                        <h5 class="text-primary m-0"><i class="fas fa-rupee-sign"></i>{{orderItemGrandTotal($order)}}</h5>
                                                                    </th>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
