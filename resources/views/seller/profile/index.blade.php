            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <a href="{{route('seller.profile.edit',$user->id)}}" class="btn btn-primary waves-effect waves-light"><i class="bx bx-pencil"></i> Edit Profile</a>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">Total Earned Amount (In one Month)</p>
