    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="custom-form needs-validation" method="post" action="{{ route('admin.page.store') }}" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Page Name" value="{{ old('name') }}" onkeyup="slug_url(this.value,'init_slug')" required/>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="summernote @error('description') is-invalid @enderror" name="description" id="editor1">{{old('description')}}</textarea>
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">This field is required. </div>
                                                @error('description')
                                                    <div class="text-danger">
