...
@section('title')
<title>Country Edit | Admin</title>
@endsection
        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.country.update',$country->id) }}" novalidate>
                        @method('PATCH')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Your Name" value="{{$country->name}}" required/>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Write somthing...">{{$country->description}}</textarea>
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">This field is required. </div>
                                                @error('description')
                                                    <div class="text-danger">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" id="square-switch3" name="status" switch="status" {{ $country->status == 1 ? "checked" : "" }} />
