                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    {{-- @if (Can::is_accessible('pin_codes', 'create')) --}}
                        <div class="page-title-right">
                            <a href="javascript:void(0);" data-href="{{ route('admin.area.create.index') }}" class="btn btn-primary waves-effect waves-light open-remote-modal">
                            ...
                            <a href="javascript:void(0);" class="btn btn-soft-success waves-effect waves-light" title="Import Area" data-bs-toggle="modal" data-bs-target="#importCSV"><i class="fas fa-file"></i> Import Area</a>
                        </div>
                    {{-- @endif --}}
                </div>
            </div>
...
<div id="importCSV" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.import.area.csv.process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-2">
                            Choose CSV File <a href="{{ route('admin.area.import.csv.download.sample') }}" download>Download sample csv</a>
                        </div>
                        <div class="col-lg-12">
    ...
    <script type="text/javascript">
        $(function() {
            $('#data-table').on('change', '.change-status', function (e) {
                ...
                $.get(`{{ route("admin.area.change.status") }}/${id}`, () => reloadTable('data-table'));
            });

            $('#data-table').DataTable({
                ajax: '{{ route("admin.area.list") }}',
                ...
                columns : [
                    ...
                    { data: 'pincode', name: 'pincodes.pincode' },
                    {
                        data: null,
                        name: 'status',
                    ...
                    },
                    {
                        ...
                        mRender: (data, type, row) => {
                            return `
                                    ...
                                    <a href="javascript:void(0);" data-href="{{ route('admin.area.update.index') }}/${row.id}" class="btn btn-soft-info btn-sm waves-effect waves-light open-remote-modal"><i class="bx bx-pencil font-size-16"></i></a>


                                    <button type="button" class="btn btn-soft-danger btn-sm waves-effect waves-light delete-entry" data-href="{{ route("admin.area.delete") }}/${row.id}" data-tbl="data"><i class="bx bx-trash font-size-16"></i></button>
