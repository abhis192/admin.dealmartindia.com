                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.banner.toggle', $banner->id) }}">
                                            ...
                                            <button type="submit" class="square-switch btn btn-toggle">
                                                <input type="checkbox" id="square-switch{{$key}}" switch="status" name="status" {{ $banner->status == 1 ? "checked" : "" }} />
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-soft-danger btn-sm waves-effect waves-light sa-delete" title="Delete Banner" data-id="{{ $banner->id }}" data-link="/admin/banner/destroy/"><i class="bx bx-trash font-size-16"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
