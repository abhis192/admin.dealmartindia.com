            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <!-- <a href="{{route('admin.kitchenPrice-Config')}}" class="btn btn-primary waves-effect waves-light"><i class="fas fa-reply-all"></i> Back to list</a> -->
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    @foreach($product->prices as $index => $price)
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="products[{{ $product->id }}][prices][{{ $index }}][price]" class="form-control" placeholder="Enter Price" value="{{ productConfigKitchenPrice($product->id, $index) }}" />
