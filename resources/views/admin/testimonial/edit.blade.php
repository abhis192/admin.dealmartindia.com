...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form class="custom-form needs-validation" method="post" action="{{ route('admin.testimonial.update',$testimonial->id) }}" enctype="multipart/form-data" novalidate>
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Your Name..." value="{{$testimonial->name}}" required />
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="country" name="country" class="form-control @error('country') is-invalid @enderror" value="{{$testimonial->country}}" placeholder="Enter Your Country..."/>
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">This field is required. </div>
                                                @error('country')
                                                    <div class="text-danger">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="summernote">{{$testimonial->description}}</textarea>
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">This field is required. </div>
                                                @error('description')
                                                    <div class="text-danger">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" id="square-switch1" switch="status" name="status" {{$testimonial->status == 1 ? 'checked' : ''}}/>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="input-file-now" name="image" class="dropify" data-default-file="{{asset('storage/testimonial/'.$testimonial->image)}}"/>
                                                <small class="text-muted"><b>Eg::</b> image size - 550x550. </small>
                                                <input type="hidden" name="hidden_image" value="{{$testimonial->image}}">
                                                @error('image')
                                                    <div class="text-danger">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
