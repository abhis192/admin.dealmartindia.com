                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Enter your phone number..." required/>
                                                @error('mobile')
                                                    <div class="text-danger">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <label for="name" class="form-label fw-bold">Published <sup class="text-danger fs-5">*</sup> :</label>
                                                <div class="square-switch">
                                                    <input type="checkbox" name="email_verified_at" id="square-switch3" switch="status" checked />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="password" name="password" class="form-control" placeholder="Enter your email id..." required/>
                                                @error('password')
                                                    <div class="text-danger">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Enter your email id..." required/>
                                            </div>
                                        </div>   
