                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-responsive invoice-table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5>{{$order->orderItems->first()->seller->business??null}}</h5>
                                                        <p class="m-0"><b>Mobile No:</b>{{$order->orderItems->first()->seller->mobile??null}}</p>
                                                        <p class="m-0"><b>Email Id:</b>{{$order->orderItems->first()->seller->email??null}}</p>

                                                        <p class="m-0"><b>Address:</b>
                                                            @if(!empty($order->orderItems->first()->seller)){
                                                            @if($order->orderItems->first()->seller->role_id == 1??null)
                                                            {{$order->orderItems->first()->seller->address??adminAddress()??null}}
                                                            @else
                                                            {{$order->orderItems->first()->seller->address??null}}
                                                            @endif

                                                        </p>
                                                        @if($order->orderItems->first()->seller->gst_name != null)
                                                        <p class="m-0"><b>GST Details:</b>{{$order->orderItems->first()->seller->gst_name??null}}[{{$order->orderItems->first()->seller->gst_no??null}}]</p>
                                                        @endif
