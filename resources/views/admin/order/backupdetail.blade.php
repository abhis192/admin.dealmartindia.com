                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            @else
                                                            <img class="rounded avatar-sm me-1" src="{{asset('storage/product/'.$item->image)}}">
                                                            @endif
                                                            <div class="desc">
                                                    ...
                                                    <td>{{$item->qty}}</td>
                                                    <td>
                                                        @if($item->discount > 0 && $item->product != null)
                                                    ...
                                                    <td><i class="fas fa-rupee-sign"></i> {{$item->product->sale_price??$item->product->regular_price *$item->qty}}</td>
                                                     @else
                                                    <td><i class="fas fa-rupee-sign"></i> {{$item->price *$item->qty}}</td>
                                                    @endif
                                                </tr>
                                                @endforeach
                                            </tbody>
