        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.all-seller.update', $user->id) }}" enctype="multipart/form-data" novalidate>
                    @method('PATCH')
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="business" name="business" class="form-control @error('business') is-invalid @enderror" placeholder="Enter Your Business Name" value="{{$user->business}}" required/>
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">This field is required. </div>
                                                @error('business')
                                                    <div class="text-danger">
                ...
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.all-seller.passwordUpdate', $user->id) }}" enctype="multipart/form-data" novalidate>
                        @method('PATCH')
                        @csrf
                ...
                <div class="card border">
                  ...
                  <!--[ Area Mapping  ] start -->
                  <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.all-seller.mappingUpdate', $user->id) }}" enctype="multipart/form-data" novalidate>
                        @method('PATCH')
                        @csrf
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-multiple" name="pincode_id[]" multiple="multiple" data-placeholder="Choose Area..." >
                                        ...
                                        {{-- @if (!empty($userMapping)) --}}
                                            ...
                                            <option value="{{$pincode->id}}"
                                                @if ($userMapping->pincode_id==$pincode->id) selected @endif>
                                        ...
                                        <option
                                            value="{{$pincode->id}}"
                                            @foreach($user->usermappings as $prodCat)
                                                @if($prodCat->pincode_id == $pincode->id)
                                                    selected
                                                @endif
                                            @endforeach
                                            >
                                ...
                                {{-- <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="pincode" id="name" class="form-control" data-placeholder="Enter Pincode">
                                        <option value=""></option>
