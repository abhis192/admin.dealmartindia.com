        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.slot.update',$slot->id) }}" novalidate>
                        @method('PATCH')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Your Full Name" value="{{$slot->name}}" required/>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" id="square-switch3" name="status" switch="status" {{ $slot->status == 1 ? "checked" : "" }} />
