                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Unverified sellers</li>
                        </ol>
                    </div>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a href="{{route('admin.unverified-seller.show', $seller->id)}}" class="dropdown-item"><i class="mdi mdi-account-box font-size-16 text-info me-1"></i> Profile</a></li>
                                                ...
                                                <li><a href="{{ route('admin.unverified-seller.edit', $seller->id) }}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                @endif
