            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <a href="{{route('admin.payouts')}}" class="btn btn-primary waves-effect waves-light"><i class="fas fa-reply-all"></i> Back to list</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row invoive-info">
                                <div class="col-md-4 col-xs-4 invoice-client-info">
                                    ...
                                    <p class="m-0"><b>Mobile No:</b></p>
                                    <p class="m-0"><b>Email Id:</b></p>
                                ...
                                <div class="col-md-6 col-xs-6 invoice-client-info">
                                    ...
                                    <p class="m-0"><b>Delivery Type :</b> </p>
                                    <p class="m-0"><b>Delivery Time:</b> </p>
                                        ...
                                        <table class="table border invoice-detail-table mt-4">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-success"> - <i class="fas fa-rupee-sign"></i></th>
                                                </tr>
                                                <tr>
                                                    <th colspan="2"></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-danger">+ <i class="fas fa-rupee-sign"></i></th>
                                                </tr>
                                                <tr>
                                                    <th colspan="2"></th>
                                                    <th>GST :</th>
                                                ...
                                                <tr class="text-info table-light">
                                                    ...
                                                    <th>
                                                        <h5 class="text-primary"><i class="fas fa-rupee-sign"></i></h5>
                                                    </th>
                                                </tr>
                                            </tfoot>
                                        </table>
