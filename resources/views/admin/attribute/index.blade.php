        ...
        <div class="row">
            <div class="col-xl-4"> 
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.product-attribute.store') }}" novalidate>
                    	@csrf
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="square-switch">
                                                	<input type="checkbox" id="square-switch0" name="status" switch="status" checked>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">  
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-soft-danger btn-sm waves-effect waves-light sa-delete" title="Delete Attribute" data-id="{{ $attribute->id }}" data-link="/admin/product/attribute/destroy/"><i class="bx bx-trash font-size-16"></i></a>
                                    </td>
                                </tr> 
                                @endforeach
                                @endif
