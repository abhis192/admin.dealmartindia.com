        ...
        <div class="row">
            <div class="col-xl-4"> 
                <div class="card border">
                    <form class="custom-form needs-validation" method="post" action="{{ route('admin.product-attribute-value.showUpdate', $attributeValues->id) }}" enctype="multipart/form-data" novalidate>
                    	@method('PATCH')
                    	@csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Your Name" value="{{$attributeValues->name}}" required/>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                @if($attribute->type == "color")
                                                    <input type="text" name="value" class="form-control @error('value') is-invalid @enderror" placeholder="Enter Value" id="colorpicker-showinput-intial" value="{{$attributeValues->value}}" />
                                                @elseif($attribute->type == "text")
                                                    <input type="text" name="value" id="name" class="form-control @error('value') is-invalid @enderror" placeholder="Value Name" value="{{$attributeValues->value}}"/>
                                                @elseif($attribute->type == "image")
                                                    <input name="value" class="form-control @error('value') is-invalid @enderror" value="{{ old('value') }}" type="file" id="formFile" value="{{$attributeValues->value}}">
                                                @endif
