                ...
                <td>
                    <table class="header-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr class="header"
                            ...
                            <td class="header-logo" align="center" style="display: block;align-items: center;padding: 10px;">
                                <a href="{{env('APP_URL')}}" style="display: block; text-align: left;">
                                    <img src="https://mbizspare.com/assets/images/logo.png" class="main-logo" alt="logo" height ="40" >
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="contant-table" style="margin-bottom: -6px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr>
                                <td>
                                    <img src="https://mbizspare.com/assets/images/welcome-poster.jpg" alt="">
                                </td>
                            </tr>
                        </thead>
                    </table>
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <h3 align="center" 
                                        style="font-weight: 700; font-size: 20px; margin: 0; text-transform: uppercase;display: block;align-items: center;">
                                        Welcome To {{env('APP_NAME')}}.!</h3>
                                </td>
                    ...
                    <table class="button-table" style="margin: 34px 0;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <a href="{{$url}}" class="password-button">Verify Email</a>
                                </td>
                            </tr>
                        </thead>
                    </table>
                                ...
                                <td style="display: block;">
                                    <p
                                        ...
                                        If you have any question, please email us at <span
                                            class="theme-color">{{configGeneral()->mobile}}.</span> You can also chat with a real live human
